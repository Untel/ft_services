if ! $(su -c 'wp core is-installed --path="/var/www"' - www); then
    su -c 'wp core install --path="/var/www" --url="192.168.99.120:5050" --title="WP Adda-sil" --admin_user="wpadda" --admin_password="wpadda" --admin_email="adrien@fernandes.bzh"' - www
